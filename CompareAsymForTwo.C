...
void CompareAsymForTwo(TString dir0="13_using_lw_pol",
  ...
  TString filename[2];
  filename[0] = "asym_plots/"+dir0+"/spin_"+classname+".root";
  filename[1] = "asym_plots/"+dir1+"/spin_"+classname+".root";
  ...
  TString mg_t = Form("A_{LL} vs. p_{T} -- red for %s -- blue for %s",dir0.Data(),dir1.Data());
