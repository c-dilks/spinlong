                  ...
                  Int_t whichEtaCut=0)
{
  ...
  switch(year) {
    case 12:
      fmsrootdir = "/home/dilks/h4/root12fms";
      counts_file = fmsrootdir+"scalers12/counts.root";
      rtree_file = fmsrootdir+"scalers12/rtree.root";
      pol_file = fmsrootdir+"polar12/pol.root";
      break;
    case 13:
